...
const resources = {
  en: {
    translation: {
      ...
      "login_failed_generic": "Login failed. Please check your credentials or try again later.",
      "popup_help": "If using Google login on mobile, ensure popups are allowed in your browser settings.",
      "clear_session": "Stuck? Clear session and try again",
  ...
  ar: {
    translation: {
      ...
      "login_failed_generic": "فشل تسجيل الدخول. يرجى التحقق من بيانات الاعتماد الخاصة بك أو المحاولة مرة أخرى لاحقًا.",
      "popup_help": "إذا كنت تستخدم تسجيل الدخول عبر Google على الهاتف، فتأكد من السماح بالنوافذ المنبثقة في إعدادات متصفحك.",
      "clear_session": "هل تواجه مشكلة؟ امسح الجلسة وحاول مرة أخرى",
